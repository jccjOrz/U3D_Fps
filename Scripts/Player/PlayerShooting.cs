...
public class PlayerShooting : NetworkBehaviour
{
    ...
    private float shootCoolDownTime = 0f;//距离上次开枪过了多久
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                autoShootCount = 0;
                InvokeRepeating("Shoot", 0f, 1f / currentWeapon.shootRate);//这里的Shoot是下面的那个函数名
    ...
    private void  OnShoot(float recoilForce)//每次射击相关的逻辑，包括特效，声音等
    {
        ...
        {
            playerController.AddRecoildForce(recoilForce);
        }
    }
    [ClientRpc]
